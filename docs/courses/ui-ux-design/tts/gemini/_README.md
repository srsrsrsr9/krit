# Gemini 3.1 Flash TTS — Composer scripts (UI/UX Design Foundations)
...
```
public/audio/ui-ux-design/<lesson-slug>.mp3
```
...
9. Drop the final mp3 at `public/audio/ui-ux-design/<lesson-slug>.mp3`.
...
The Krit narrator is *a dry-funny Indian design-studio lecturer who has shipped enough product to be opinionated*. Closer to a Bengaluru design lead reviewing your Figma file over filter coffee than a Coursera instructor.
...
|---|---|---|---|---|
| 1 | Visual Hierarchy | `1-visual-hierarchy.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
| 2 | Layout and Grid | `2-layout-and-grid.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
| 3 | Color and Typography | `3-color-and-typography.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
| 4 | Interaction and Microcopy | `4-interaction-and-microcopy.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
| 5 | Design Critique Loop | `5-design-critique-loop.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
