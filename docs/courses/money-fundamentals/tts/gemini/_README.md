# Gemini 3.1 Flash TTS — Composer scripts
...
```
public/audio/money-fundamentals/<lesson-slug>.mp3
```
...
9. Drop the final mp3 at `public/audio/money-fundamentals/<lesson-slug>.mp3`.
...
The Krit narrator is *a dry-funny Indian university lecturer who likes their subject*. Closer to a Bengaluru product manager telling a story over chai than an Audible thriller narrator. For the money course, the lecturer leans slightly more opinionated — they will name products by name and tell you not to buy them.
...
|---|---|---|---|---|
| 1 | The Lifestyle Inflation Trap | `1-lifestyle-inflation.md` | 12:00 | 0 / 90 / 240 / 440 / 600 |
| 2 | The Boring Cheat Code | `2-emergency-fund.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
| 3 | Compounding Is Not Magic | `3-compounding-cascade.md` | 12:00 | 0 / 90 / 240 / 440 / 600 |
| 4 | SIP, Index Funds, and the Maze | `4-investing-basics-india.md` | 12:00 | 0 / 90 / 240 / 440 / 600 |
| 5 | The 14-Day Money Audit | `5-money-audit.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
