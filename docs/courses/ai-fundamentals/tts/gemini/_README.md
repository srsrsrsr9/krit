...
```
public/audio/ai-fundamentals/<lesson-slug>.mp3
```
...
9. Drop the final mp3 at `public/audio/ai-fundamentals/<lesson-slug>.mp3`.
...
The Krit narrator is *a dry-funny Indian university lecturer who likes their subject*. Closer to a Bengaluru product manager telling a story over chai than an Audible thriller narrator.
...
|---|---|---|---|---|
| 1 | What an LLM Actually Is | `1-what-an-llm-is.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
| 2 | Prompting Without the Cargo Culture | `2-prompting-without-cargo.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
| 3 | The Hallucination Problem | `3-hallucination-trap.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
| 4 | When AI Is the Right Tool | `4-tool-fit-judgment.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
| 5 | Building an AI-Augmented Workflow | `5-workflow-design.md` | 12:00 | 0 / 90 / 240 / 440 / 600 |
