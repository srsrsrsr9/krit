# Gemini 3.1 Flash TTS — Composer scripts (Python Foundations)
...
```
public/audio/python-foundations/<lesson-slug>.mp3
```
...
9. Drop the final mp3 at `public/audio/python-foundations/<lesson-slug>.mp3`.
...
The Krit narrator is *a dry-funny Indian university lecturer who likes their subject*. For Python Foundations, lean into the engineering-team-lead persona — the senior dev who has shipped enough production Python to be unimpressed by anyone's clever one-liner.
...
Pricing: Chirp 3 HD is ~$30 per 1M characters. Each lesson is ~11K characters → all 5 lessons cost ~$1.65 total.
...
## A note on rendering code aloud

These scripts deliberately avoid reading raw Python out loud. Where a code idea has to be voiced, the lecturer paraphrases — *"a function whose default argument is an empty list"* instead of *"def f open paren x equals open square bracket close square bracket close paren"*. If you ever feel the urge to TTS-narrate code, don't. Voice the *intent*, leave the syntax to the screen.
...
|---|---|---|---|---|
| 1 | Variables Are Stickers, Not Boxes | `1-python-types-stickers.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
| 2 | Control Flow Without the Ceremony | `2-python-control-flow.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
| 3 | Functions Are Plug-In Tools | `3-python-functions.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
| 4 | Pick the Right Container | `4-python-collections.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
| 5 | Putting It Together: A Real Mini-Project | `5-python-mini-project.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
