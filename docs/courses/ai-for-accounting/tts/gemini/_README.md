# Gemini 3.1 Flash TTS — Composer scripts (AI for Accounting)
...
```
public/audio/ai-for-accounting/<lesson-slug>.mp3
```
...
9. Drop the final mp3 at `public/audio/ai-for-accounting/<lesson-slug>.mp3`.
...
The Krit narrator for this course is *a dry-funny senior CA explaining to younger CAs over filter coffee why their AI experiments will get them a notice.* Bengaluru / Pune classroom register. Calm, technical, lightly weary, occasionally amused at the profession's own panic.
...
|---|---|---|
| **`en-IN-Chirp3-HD-Charon`** | Informative, calm Indian male | **Default for this course — senior-CA lecturer tone** |
...
| `en-IN-Chirp3-HD-Kore` | Firm Indian female | More gravitas, partner-ish |
...
| Voice | Vibe |
|---|---|
| **Niraj** (Indian English Male) | Mature, informative — best CA-lecturer match |
| Raju (Indian English Male) | Younger, casual — for the articled-assistant POV blocks |
...
| Voice | Vibe | Note |
|---|---|---|
| Charon | Informative, calm, dry | Closest to the senior-CA tone — but no real Indian accent |
| Kore | Firm, measured | Heavier register — partner-style |
...
## A note on Indian tax terminology

These scripts are loaded with real Indian tax terms — **GSTR-2A**, **GSTR-2B**, **GSTR-3B**, **Section 16 ITC**, **Form 3CD**, **Section 194Q TDS**, **Section 17(5)**, **HSN code**, **ICAI**, **Assessing Officer**, **CGST/SGST/IGST**, **bare act**. Do not let your TTS engine "auto-correct" these. If a voice mispronounces "GSTR" as "G S T R" (letter-by-letter), that is correct and intended. "Three CD" for "Form 3CD" is also correct.

For Hinglish blocks: "kahaani" = story, "kavita" = poem, "bhanda phod" = exposing/blowing the cover. Don't translate them in transit.
...
Each script keeps the cultural-aside content in Hinglish, with the audio tag `[switching to Hinglish, warm]` opening the section and `[returning to English, dry]` closing it. Gemini 3.1 Flash multilingual mode handles this well in our testing. ElevenLabs Multilingual v2 handles it best.
...
|---|---|---|---|---|
| 1 | Where AI Meets the Ledger | `1-ai-meets-ledger.md` | ~11:00 | 0 / 80 / 220 / 410 / 560 |
| 2 | Prompting for Financials | `2-prompting-for-financials.md` | ~11:00 | 0 / 80 / 220 / 410 / 560 |
| 3 | AI in Reconciliation | `3-ai-reconciliation.md` | ~11:00 | 0 / 80 / 220 / 410 / 560 |
| 4 | GST, TDS, and Indian Tax Workflows | `4-ai-gst-tds.md` | ~11:00 | 0 / 80 / 220 / 410 / 560 |
| 5 | Audit Trails: When AI Cannot Sign | `5-ai-audit-trail.md` | ~11:00 | 0 / 80 / 220 / 410 / 560 |
