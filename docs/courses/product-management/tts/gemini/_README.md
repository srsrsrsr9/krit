# Gemini 3.1 Flash TTS — Composer scripts (Product Management)

Five drop-in scripts for Google AI Studio's Gemini 3.1 Flash TTS Composer (Playground → Composer mode). Each file is paste-ready for one lesson's audio file in the **Product Management Fundamentals** path.

```
public/audio/product-management/<lesson-slug>.mp3
```
...
9. Drop the final mp3 at `public/audio/product-management/<lesson-slug>.mp3`.
...
The Krit narrator for this course is *a dry-funny Bengaluru product lecturer who has shipped, killed, and re-shipped enough features to know better*. Closer to a senior PM telling stories over filter coffee than an Audible thriller narrator. They have firm opinions: outcome over output, a roadmap longer than a quarter is fiction, every TBD is a deferred bug.
...
| Kore | Firm, measured | Heavier register — works for the roadmap and shipping lessons |
| Aoede | Breezy, friendly | Lighter register — softer alternative for the user-research lesson |
...
## Course voice — opinions the lecturer holds, on purpose

Unlike a generic narrator, this lecturer takes sides. Keep these intact when editing — they are the spine of the course voice.

- **Outcome over output.** Always. Counting features shipped is how teams build museums.
- **A roadmap longer than a quarter is fiction.** Direction beyond Q is fine; dates beyond Q are wedding-card aspirations.
- **Every TBD in a PRD is a deferred bug.** Either decide, or write 'open question, blocking, owner, by date.'
- **Ship-day is day 0, not day 30.** The launch blog is theatre; the kill signal lives in week 3.
- **JIRA-monkey work is not the job.** Translation and sequencing is the job.
...
|---|---|---|---|---|
| 1 | What a PM Actually Does | `1-pm-mental-model.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
| 2 | Talking to Users Without Getting Lied To | `2-talking-to-users.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
| 3 | PRDs, Specs, and the Art of Prioritization | `3-prd-and-prioritization.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
| 4 | Roadmaps, Quarterly Plans, and Saying No | `4-roadmaps-and-tradeoffs.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
| 5 | Shipping, Measuring, and What Comes After | `5-shipping-and-followup.md` | 11:00 | 0 / 80 / 220 / 410 / 560 |
